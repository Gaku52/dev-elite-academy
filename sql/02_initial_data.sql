...
-- 学習カテゴリーの初期データ
-- 基本情報技術者試験の3分野に対応
-- テクノロジ系: 41問/60問 | マネジメント系: 7問/60問 | ストラテジ系: 12問/60問

INSERT INTO categories (name, description, icon, color, sort_order) VALUES
-- 🔧 テクノロジ系（41問/60問）
('コンピュータシステム【テクノロジ系】', 'ハードウェア、ソフトウェア、システム構成の基礎知識', '💻', '#3B82F6', 1),
('アルゴリズムとプログラミング【テクノロジ系】', 'プログラミング言語、データ構造、アルゴリズムの基本', '⚙️', '#3B82F6', 2),
('データベース【テクノロジ系】', 'データベースの基本概念とSQL', '🗄️', '#3B82F6', 3),
('ネットワーク【テクノロジ系】', 'ネットワーク技術とプロトコルの基礎', '🌐', '#3B82F6', 4),
('セキュリティ【テクノロジ系】', '情報セキュリティの基本概念と対策', '🔒', '#3B82F6', 5),

-- 📊 マネジメント系（7問/60問）
('システム開発【マネジメント系】', 'システム開発手法とプロジェクトマネジメント', '📋', '#10B981', 6),

-- 🎯 ストラテジ系（12問/60問）
('経営・法務【ストラテジ系】', '企業活動と法務の基礎知識', '🏢', '#8B5CF6', 7),
('ストラテジ【ストラテジ系】', 'IT戦略・システム戦略', '🎯', '#8B5CF6', 8),

-- その他の資格（参考用）
('AWS認定', 'Amazon Web Servicesのクラウドサービス', '☁️', '#FF6B35', 9),
('Azure認定', 'Microsoft Azureのクラウドプラットフォーム', '🔵', '#0078D4', 10);
