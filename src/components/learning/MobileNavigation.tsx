...
export default function MobileNavigation({
  ...
  return (
    <div className="lg:hidden bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 mb-4">
      <select
        value={`${activeModule}-${activeSection}`}
        onChange={handleChange}
        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
      >
