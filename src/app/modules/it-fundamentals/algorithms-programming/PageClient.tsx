...
import { learningModules } from '@/data/modules/it-fundamentals/algorithms-programming';
...
export default function AlgorithmsProgrammingPage() {
  ...
  const { progress, saveProgress } = useLearningProgress('algorithms-programming');
  ...
  // メインページと同じ値を使用
  const totalQuizzes = moduleQuizCounts['algorithms-programming'] || 0;
