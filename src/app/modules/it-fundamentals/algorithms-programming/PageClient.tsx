    ...
    if (serverProgressElement) {
      try {
        ...
        if (serverProgress.length > 0 && !isInitialized) {
          console.log('🚀 Loading initial server-side progress (algorithms-programming)...');
          ...
          console.log('✅ Initial server progress loaded (algorithms-programming):', { completed: completedSet.size, answers: Object.keys(answersMap).length });
          return;
        }
      } catch (error) {
