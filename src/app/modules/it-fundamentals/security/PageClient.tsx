...
export default function SecurityPage() {
  ...
  // メインページと同じ値を使用
  const totalQuizzes = moduleQuizCounts['security'] || 0;
            ...
            <div className="bg-card rounded-lg shadow-sm border border-border">
              <div className="p-4 lg:p-6">
                ...
                <div className="border-t border-border pt-6">
                  <div className="bg-gradient-to-r from-orange-50 to-indigo-50 dark:from-orange-900/90 dark:to-indigo-900/90 rounded-lg p-4 lg:p-6 mb-6 border border-orange-200 dark:border-orange-700">
