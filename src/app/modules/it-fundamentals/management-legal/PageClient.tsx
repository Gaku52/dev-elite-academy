...
export default function ManagementLegalPage() {
  ...
  useEffect(() => {
    if (progress.length > 0) {
      console.log('🔄 Restoring management-legal progress state...');
      ...
      console.log('✅ Management-legal progress restored:', { completed: completedSet.size, answers: Object.keys(answersMap).length });
    }
  }, [progress]);
  ...
  const handleQuizAnswer = async (answer: number) => {
    ...
    try {
      ...
      console.log('✅ Management-legal progress saved:', { section: quizKey, correct: isCorrect });
    } catch (error) {
            ...
            <div className="bg-card rounded-lg shadow-sm border border-border">
              <div className="p-4 lg:p-6">
                ...
                <div className="border-t border-border pt-6">
                  <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/90 dark:to-indigo-900/90 rounded-lg p-4 lg:p-6 mb-6 border border-purple-200 dark:border-purple-700">
