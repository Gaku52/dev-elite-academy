              ...
              <div className="p-4 lg:p-6">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6">
                  ...
                  <div className="flex items-center space-x-2 text-sm">
                    <span className="px-3 py-1 bg-green-100 dark:bg-green-900/50 text-green-900 dark:text-green-200 rounded-full border border-green-200 dark:border-green-700">
                      {currentModule.title}
                    </span>
                ...
                <div className="border-t border-border pt-6">
                  <div className="bg-slate-50 dark:bg-slate-500 rounded-lg p-4 lg:p-6 mb-6 border border-green-200 dark:border-green-700">
