...
import { learningModules } from '@/data/modules/it-fundamentals/strategy';
import {
  LearningHeader,
  ModuleSidebar,
  MobileNavigation,
...
export default function StrategyPage() {
  ...
  useEffect(() => {
    if (progress.length > 0) {
      console.log('🔄 Restoring strategy progress state...');
      ...
      console.log('✅ Strategy progress restored:', { completed: completedSet.size, answers: Object.keys(answersMap).length });
    }
  }, [progress]);
  ...
  // メインページと同じ値を使用
  const totalQuizzes = moduleQuizCounts['strategy'] || 0;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-7xl mx-auto px-4 py-4 lg:py-8">
        ...
        <LearningHeader
          title="ストラテジ"
          description="システム戦略・経営戦略・技術戦略を体系的に学習"
          backLink="/modules/it-fundamentals"
              ...
              <div className="p-4 lg:p-6">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6">
                  ...
                  <div className="flex items-center space-x-2 text-sm">
                    <span className="px-3 py-1 bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-200 rounded-full border border-green-200 dark:border-green-700">
                      {currentModule.title}
                    </span>
                ...
                <div className="border-t border-border pt-6">
                  <div className="bg-gradient-to-r from-green-50 to-indigo-50 dark:from-green-900/60 dark:to-indigo-900/60 rounded-lg p-4 lg:p-6 mb-6 border border-green-200 dark:border-green-700">
