...
RTO（Recovery Time Objective）: 許容できる復旧時間`,
  ...
  },
  {
    ...
    sections: [
      {
        title: '離散数学',
        content: `離散数学は情報工学の基礎となる数学分野です：

**論理演算:**
- AND（論理積）: 両方が真のときのみ真
- OR（論理和）: 少なくとも一方が真のとき真
- NOT（論理否定）: 真偽を反転
- XOR（排他的論理和）: 一方のみが真のとき真
- NAND: ANDの否定
- NOR: ORの否定
...
**場合の数と確率:**
- 順列（P）: 順序を考慮した組み合わせ
- 組み合わせ（C）: 順序を考慮しない組み合わせ
- 確率の基本性質と計算`,
        quizzes: [
          {
            question: 'A∧B∨¬Cにおいて、A=真、B=偽、C=真のとき、式の値は？',
            options: ['真', '偽', '不定', 'エラー'],
            correct: 1,
            explanation: 'A∧B = 真∧偽 = 偽、¬C = ¬真 = 偽、よって 偽∨偽 = 偽'
          },
          {
            question: '集合A={1,2,3}、B={2,3,4}のとき、A∩Bは？',
            options: ['{1}', '{2,3}', '{4}', '{1,2,3,4}'],
            correct: 1,
            explanation: '積集合A∩Bは両方の集合に共通する要素で、{2,3}です。'
          },
          {
            question: '5人から3人を選んで順番に並べる場合の数は？',
            options: ['10', '60', '125', '15'],
            correct: 1,
            explanation: '順列P(5,3) = 5!/(5-3)! = 5×4×3 = 60通り'
          },
          {
            question: 'ド・モルガンの法則で¬(A∨B)と等価なものは？',
            options: ['¬A∨¬B', '¬A∧¬B', 'A∧B', 'A∨B'],
            correct: 1,
            explanation: 'ド・モルガンの法則により、¬(A∨B) = ¬A∧¬B'
          },
          {
            question: '10個の異なるボールから3個選ぶ組み合わせの数は？',
            options: ['30', '120', '720', '1000'],
            correct: 1,
            explanation: 'C(10,3) = 10!/(3!×7!) = (10×9×8)/(3×2×1) = 120'
          },
          {
            question: 'XOR演算A⊕Bの特徴として正しいものは？',
            options: ['A=Bのとき真', 'A≠Bのとき真', '常に真', '常に偽'],
            correct: 1,
            explanation: 'XOR（排他的論理和）は、AとBが異なるときのみ真になります。'
          },
          {
            question: '条件付き確率P(A|B)の意味は？',
            options: ['AまたはBが起こる確率', 'AかつBが起こる確率', 'Bが起こったときAが起こる確率', 'AもBも起こらない確率'],
            correct: 2,
            explanation: 'P(A|B)は事象Bが起こったという条件下で事象Aが起こる確率です。'
          },
          {
            question: '補集合Aの性質として正しいものは？',
            options: ['A∪A=A', 'A∩A=∅', 'A∪A=U（全体集合）', 'A∩A=A'],
            correct: 2,
            explanation: '集合Aとその補集合Aの和集合は全体集合Uになります。'
          },
          {
            question: '真理値表でNAND演算の結果が偽になるのは？',
            options: ['A=真、B=真のとき', 'A=偽、B=偽のとき', 'A=真、B=偽のとき', 'A=偽、B=真のとき'],
            correct: 0,
            explanation: 'NAND（NOT AND）は、ANDの否定なので、A=真、B=真のときのみ偽になります。'
          },
          {
            question: '樹形図で表現できる概念は？',
            options: ['集合の包含関係', '場合の数の計算', '論理演算の結果', '関数の定義域'],
            correct: 1,
            explanation: '樹形図は、複数の選択肢がある場合の数を視覚的に表現する方法です。'
          }
        ]
      },
      {
        title: '数値表現',
        content: `コンピュータ内部でのデータ表現方法：

**基数変換:**
- 2進数: 0と1で表現（コンピュータの基本）
- 8進数: 0-7で表現
- 16進数: 0-9、A-Fで表現
- 変換方法: 除算法、重み付け法

**負数の表現:**
- 符号ビット方式: 最上位ビットで正負を表現
- 1の補数: 各ビットを反転
- 2の補数: 1の補数に1を加算（一般的）

**浮動小数点:**
- IEEE754標準: 単精度32ビット、倍精度64ビット
- 符号部（1ビット）+ 指数部 + 仮数部
- 正規化表現と非正規化表現
...
- ASCII: 7ビット文字コード
- Unicode: 国際標準文字コード
- UTF-8, UTF-16: Unicodeの符号化方式`,
        quizzes: [
          {
            question: '10進数25を2進数で表すと？',
            options: ['11001', '10101', '11010', '10011'],
            correct: 0,
            explanation: '25 = 16+8+1 = 2⁴+2³+2⁰ = 11001₂'
          },
          {
            question: '16進数AFを10進数で表すと？',
            options: ['165', '175', '185', '195'],
            correct: 1,
            explanation: 'AF₁₆ = 10×16¹ + 15×16⁰ = 160 + 15 = 175'
          },
          {
            question: '8ビットでの-5を2の補数で表すと？',
            options: ['10000101', '11111011', '01111011', '10001011'],
            correct: 1,
            explanation: '5 = 00000101 → 1の補数 = 11111010 → 2の補数 = 11111011'
          },
          {
            question: '2進数1101.01を10進数で表すと？',
            options: ['13.25', '13.5', '12.25', '14.25'],
            correct: 0,
            explanation: '1×2³ + 1×2² + 0×2¹ + 1×2⁰ + 0×2⁻¹ + 1×2⁻² = 8+4+0+1+0+0.25 = 13.25'
          },
          {
            question: 'IEEE754単精度浮動小数点の指数部のビット数は？',
            options: ['7ビット', '8ビット', '9ビット', '10ビット'],
            correct: 1,
            explanation: 'IEEE754単精度（32ビット）は、符号1ビット + 指数8ビット + 仮数23ビット'
          },
          {
            question: 'ASCII文字コードで文字Aの値は？',
            options: ['64', '65', '66', '67'],
            correct: 1,
            explanation: 'ASCII文字コードで大文字Aは65（41₁₆）です。'
          },
          {
            question: '8ビット2の補数表現で表せる数値の範囲は？',
            options: ['-127～127', '-128～127', '0～255', '-255～255'],
            correct: 1,
            explanation: '8ビット2の補数は-2⁷～2⁷-1、つまり-128～127の範囲を表現できます。'
          },
          {
            question: 'BCD（Binary Coded Decimal）の特徴は？',
            options: ['1桁を4ビットで表現', '効率的な記憶方式', '負数表現が容易', '浮動小数点専用'],
            correct: 0,
            explanation: 'BCDは10進数の各桁を4ビットの2進数で表現する方式です。'
          },
          {
            question: 'UTF-8の特徴として正しいものは？',
            options: ['固定長8ビット', '可変長1-4バイト', 'ASCII非互換', '日本語専用'],
            correct: 1,
            explanation: 'UTF-8は1-4バイトの可変長符号化方式で、ASCIIと互換性があります。'
          },
          {
            question: 'エクセス127表現（バイアス表現）が使われるのは？',
            options: ['整数部', '小数部', '指数部', '符号部'],
            correct: 2,
            explanation: '浮動小数点の指数部では、負の指数も扱うためエクセス表現を使用します。'
          }
        ]
      },
      {
...
**基本ゲート:**
- ANDゲート: 入力がすべて1のとき出力1
- ORゲート: 入力の少なくとも一つが1のとき出力1
- NOTゲート: 入力を反転
- NANDゲート: ANDの否定（万能ゲート）
- NORゲート: ORの否定（万能ゲート）
- XORゲート: 入力が異なるとき出力1
...
- 半加算器: 1ビット同士の加算
- 全加算器: 桁上がりを含む1ビット加算
- デコーダ: nビット入力を2ⁿ本の出力に変換
- エンコーダ: 2ⁿ本の入力をnビット出力に変換
- マルチプレクサ: 複数入力から1つを選択
- デマルチプレクサ: 1つの入力を複数出力に分配
...
- カウンタ: 計数回路`,
        quizzes: [
          {
            question: 'NANDゲートが万能ゲートと呼ばれる理由は？',
            options: ['最も高速だから', 'すべての論理演算が実現できるから', '消費電力が少ないから', '実装が簡単だから'],
            correct: 1,
            explanation: 'NANDゲートのみでAND、OR、NOTすべてを実現でき、あらゆる論理回路を構成できます。'
          },
          {
            question: '半加算器の出力で正しいものは？',
            options: ['和とオーバーフロー', '和と桁上がり', '積と余り', '商と余り'],
            correct: 1,
            explanation: '半加算器は2つの1ビット入力の和（Sum）と桁上がり（Carry）を出力します。'
          },
          {
            question: '3-8デコーダの入力ビット数は？',
            options: ['2ビット', '3ビット', '4ビット', '8ビット'],
            correct: 1,
            explanation: '3-8デコーダは3ビット入力（2³=8通り）を8本の出力線のうち1本を選択する回路です。'
          },
          {
            question: 'D型フリップフロップの特徴は？',
            options: ['データを遅延させる', 'クロックでデータを取り込む', '発振回路を構成', '論理演算を行う'],
            correct: 1,
            explanation: 'D型フリップフロップはクロック信号でデータ入力Dの値を取り込んで記憶します。'
          },
          {
            question: '4ビット全加算器で1111+0001を計算した結果は？',
            options: ['0000（桁上がり1）', '1111（桁上がり0）', '1000（桁上がり0）', '0001（桁上がり1）'],
            correct: 0,
            explanation: '1111₂ + 0001₂ = 10000₂ で、4ビットでは0000、桁上がり1となります。'
          },
          {
            question: '4-1マルチプレクサの選択信号のビット数は？',
            options: ['1ビット', '2ビット', '3ビット', '4ビット'],
            correct: 1,
            explanation: '4入力から1つを選ぶには2²=4通りの選択が必要なので、選択信号は2ビットです。'
          },
          {
            question: 'XORゲートの用途として適切でないものは？',
            options: ['加算回路', 'パリティチェック', '比較回路', 'アンプ回路'],
            correct: 3,
            explanation: 'XORゲートは論理演算に使われ、信号増幅を行うアンプ回路とは無関係です。'
          },
          {
            question: 'JKフリップフロップでJ=1、K=1のときの動作は？',
            options: ['セット', 'リセット', '保持', 'トグル（反転）'],
            correct: 3,
            explanation: 'JKフリップフロップでJ=K=1のときは、クロック毎に出力が反転（トグル）します。'
          },
          {
            question: '優先エンコーダの特徴は？',
            options: ['入力の優先順位がある', '出力の優先順位がある', 'クロック同期', 'アナログ処理'],
            correct: 0,
            explanation: '優先エンコーダは複数入力が同時にアクティブでも、優先順位に基づいて符号化します。'
          },
          {
            question: 'リップルカウンタの特徴は？',
            options: ['同期式', '非同期式', '双方向', '可逆式'],
            correct: 1,
            explanation: 'リップルカウンタは前段の出力が次段のクロックとなる非同期式カウンタです。'
          }
        ]
      }
    ]
